...
export default function RSVPBlock({
  ...
  return (
    <section
      id={id}
      className="relative w-full min-h-[100dvh] flex flex-col justify-between items-center overflow-hidden select-none bg-black text-on-surface transform translate-x-0"
    >
